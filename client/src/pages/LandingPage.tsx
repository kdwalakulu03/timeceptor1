    ...
    <div className="relative min-h-screen selection:bg-gold/30 selection:text-gold-light">
      ...
      <footer className="relative z-10 border-t border-gold/10 px-4 sm:px-6 py-6">
        ...
        <div className="flex flex-wrap justify-center items-center gap-3 sm:gap-5 mt-4 pt-4 border-t border-gold/5">
          <a href="https://www.facebook.com/timeceptor" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 font-mono text-[10px] sm:text-xs text-cream-dim/60 tracking-widest hover:text-gold transition-colors">
            <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
            Facebook
          </a>
          <a href="https://www.instagram.com/timeceptor" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 font-mono text-[10px] sm:text-xs text-cream-dim/60 tracking-widest hover:text-gold transition-colors">
